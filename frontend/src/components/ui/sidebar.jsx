    ...
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        style={{
          ...
          "--sidebar-floating-offset": "0.5rem",
          ...style,
        }}
        className={cn(
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "w-[calc(var(--sidebar-width)+(var(--sidebar-floating-offset)*2))] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(var(--sidebar-floating-offset)*2))]"
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "w-[calc(var(--sidebar-width)+(var(--sidebar-floating-offset)*2))] p-[var(--sidebar-floating-offset)] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(var(--sidebar-floating-offset)*2)+2px)]"
